...
function cardEl(p,z,c,visible){
  ...
  if(!visible||c.faceUp===false){
    ...
    img.src=(z==="energy"?CROPPED_CARD_IMAGE_BASE:CARD_IMAGE_BASE)+encodeURIComponent(c.name)+".png"+(z==="energy"?"?energyv=3":"");img.alt=c.name;img.loading="lazy";img.style.transformOrigin="50% 50%";if(c.tapped)img.style.transform="rotate(-15deg)";
