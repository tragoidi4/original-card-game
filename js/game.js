...
const ENERGY_IMAGE_BASE="https://raw.githubusercontent.com/Omezi42/AnokoroImageFolder/main/images/cropped_cards/";

const state={turnPlayer:1,selected:null,players:{}};
let cardNames=[];

function imageUrl(name,base=CARD_IMAGE_BASE){return base+encodeURIComponent(name)+".png";}
...
function cardEl(p,z,c,visible){
  ...
  if(!visible||c.faceUp===false){
    ...
    img.src=imageUrl(c.name,z==="energy"?ENERGY_IMAGE_BASE:CARD_IMAGE_BASE);img.alt=c.name;img.loading="lazy";
